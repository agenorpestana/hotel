...
if($linhas == 0){
	...
	$descricao_taxa = $res[0]['descricao_taxa'];
	$valor_taxa = $res[0]['valor_taxa'];
...
<br>
		...
		<table id="cabecalhotabela" style="border-bottom-style: solid; font-size: 12px; margin-bottom:10px; width: 100%; table-layout: fixed; margin-top: -50px">
		...
		<table id="cabecalhotabela" style="border-bottom-style: solid; font-size: 12px; margin-bottom:10px; width: 100%; table-layout: fixed;">
			...
			<thead>
				...
				<tr id="cabeca" style="margin-left: 0px;">
					...
					<td style="width:25%"><?php echo $valor_reservaF ?></td>
	...
	<?php if($hora_checkout != ""){ ?>
			...
			<div style="border-bottom: 1px solid #000; margin-top: 30px">
				...
				<div style="font-size: 11px; margin-bottom: 7px"><b>DETALHAMENTO DO CHECK-OUT</b>
					<?php if($valor_taxa > 0){ ?>
						<small><span>(Taxa: <?php echo $descricao_taxa ?> R$ <span style="color:red"><?php echo $valor_taxaF ?></span>)</span></small>
					<?php } ?>
				</div>
