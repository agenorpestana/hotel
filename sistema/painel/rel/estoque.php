		...
		<table style="width: 100%; border: 0px solid #ccc;">
			...
			<tr>
				...
				<td style="width: 40%; text-align: right; font-size: 9px;padding-right: 10px;">
						...
						<b><big>RELATÓRIO DE ESTOQUE BAIXO</big></b><br>  <br> <?php echo mb_strtoupper($data_hoje) ?>
...
$query = $pdo->query("SELECT * from produtos where estoque < nivel_estoque and ativo = 'Sim' order by id desc");
			...
			<thead>
				...
				<tbody>
					...
					<tr>
						...
						<td style="font-size: 10px; width:750px; text-align: right;"><b>Estoque Baixo:</b><span > <?php echo $linhas ?></span> </td>
