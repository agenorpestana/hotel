...
$valores_criancas = 'ocultar';
$valores_datas = 'ocultar';
$bloqueio_datas = 'ocultar';
$mapa_reservas = 'ocultar';
...
if($total_reg > 0){
	for($i=0; $i < $total_reg; $i++){
		...
		if($chave == 'valores_criancas'){
			$valores_criancas = '';
		}

		if($chave == 'valores_datas'){
			$valores_datas = '';
		}

		if($chave == 'bloqueio_datas'){
			$bloqueio_datas = '';
		}
...
if($reservas == 'ocultar' and $filtrar_reservas == 'ocultar' and $rel_quartos == 'ocultar' and $quadro_reservas == 'ocultar' and $valores_criancas == 'ocultar' and $valores_datas == 'ocultar' and $bloqueio_datas == 'ocultar' and $mapa_reservas == 'ocultar'){
