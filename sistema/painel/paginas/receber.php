...
<div class="row">
	...
	<div class="col-md-10">
		...
		<div style="float:left; margin-right:35px">
			...
			<button onclick="inserir()" type="button" class="btn btn-primary btn-flat btn-pri"><i class="fa fa-plus" aria-hidden="true"></i>Recebimento</button>
					...
					<div class="row">
						...
						<div class="col-md-3">						
							...
							<div class="form-group"> 
								...
								<input type="date" class="form-control" name="data_venc" id="data_venc" value="<?php echo date('Y-m-d') ?>" required> 
						...
						<div class="col-md-4">						
							...
							<div class="form-group"> 
								...
								<select class="form-control sel2" name="hospede" id="hospede" style="width:100%;"> 
									...
									$query = $pdo->query("SELECT * FROM hospedes where responsavel = 'Sim' order by nome asc");
