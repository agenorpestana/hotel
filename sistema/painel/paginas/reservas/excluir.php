...
$pdo->query("INSERT INTO pagar SET descricao = '$texto_descricao', valor = '$valor_devolucao', data_venc = '$nova_data_venc', data_lanc = curDate(), usuario_lanc = '$id_usuario', arquivo = 'sem-foto.png', pago = 'Não',  hospede = '$hospede', referencia = 'Cancelamento', id_ref = '$id', caixa = '$id_caixa'");	
