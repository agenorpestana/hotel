...
$query = $pdo->prepare("INSERT INTO $tabela SET logo_site = '$logo_site', titulo_sobre = :titulo_sobre, descricao_sobre1 = :descricao_sobre1, descricao_sobre2 = :descricao_sobre2, descricao_sobre3 = :descricao_sobre3, video_sobre_index = :video_sobre_index, foto_video_sobre = '$foto_video_sobre', foto_sobre_index = '$foto_sobre_index', foto_sobre_pagina = '$foto_sobre_pagina', foto_banner_mobile = '$foto_banner_mobile', mapa = :mapa");
