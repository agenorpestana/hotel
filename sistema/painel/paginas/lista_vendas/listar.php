...
$query = $pdo->query("SELECT * from $pagina where referencia = 'Venda' and pago = 'Não'");
...
if($alterou_data == 'Sim'){
	...
	if($dataInicial != "" || $dataFinal != ""){
		...
		$query = $pdo->query("SELECT * from $pagina where (data_lanc >= '$dataInicial' and data_lanc <= '$dataFinal') and pago LIKE '$status' and referencia = 'Venda' order by id desc ");
	...
	$query = $pdo->query("SELECT * from $pagina WHERE data_lanc = curDate() and referencia = 'Venda' order by id desc ");
