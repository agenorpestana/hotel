...
<div class="margin_mobile">
	...
	<div class="row">
		...
		$query = $pdo->query("SELECT * from categorias_produtos where ativo = 'Sim' order by id asc");
...
if($linhas > 0){
	...
	$query2 = $pdo->query("SELECT * from produtos where (categoria = '$id' and tem_estoque = 'Não' and ativo = 'Sim') or (categoria = '$id' and tem_estoque = 'Sim' and estoque > 0 and ativo = 'Sim')");
...
<div class="col-md-3 widget" style="margin-right: 5px; margin-bottom: 5px; ">			<div class="r3_counter_box" style="min-height: 60px; padding:10px">
				...
				<i class="pull-left fa " style="background-image:url('images/produtos/<?php echo $foto ?>'); background-size: cover;"></i>
			...
			<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-5">							
							...
							<div class="col-md-12" id="div_forma_pgto" style="display:none">							

								<label>Forma de Pagamento</label>

								<select class="form-control sel2" name="forma_pgto" id="forma_pgto" style="width:100%;">						
									<?php 
