...
if($fornecedor != "0"){
	$query = $pdo->prepare("INSERT INTO $tabela SET nome = :nome,  data_cad = curDate(), usuario = '$id_usuario', arquivo = '$foto', registro = 'Fornecedores', id_reg = '$fornecedor'");
	$query->bindValue(":nome", "$nome");
	$query->execute();
...
if($funcionario != "0"){
	$query = $pdo->prepare("INSERT INTO $tabela SET nome = :nome,  data_cad = curDate(), usuario = '$id_usuario', arquivo = '$foto', registro = 'Funcionários', id_reg = '$funcionario'");
	$query->bindValue(":nome", "$nome");
	$query->execute();
...
if($hospede != "0"){
	$query = $pdo->prepare("INSERT INTO $tabela SET nome = :nome,  data_cad = curDate(), usuario = '$id_usuario', arquivo = '$foto', registro = 'Hóspedes', id_reg = '$hospede'");
	$query->bindValue(":nome", "$nome");
	$query->execute();
