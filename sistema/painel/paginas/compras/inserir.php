...
if($data_pgto == ""){
	...
	$sql_pgto = " , data_pgto = '$data_pgto' ";
	$sql_usu_pgto = " , usuario_pgto = '$id_usuario' ";
}
...
if($id == ""){
	...
	$query = $pdo->prepare("INSERT INTO $tabela SET descricao = :descricao, fornecedor = '$fornecedor', valor = :valor, data_venc = '$data_venc', data_lanc = curDate(), usuario_lanc = '$id_usuario', arquivo = '$foto', pago = '$pago', funcionario = '0', obs = :obs, hospede = '0', referencia = 'Compra', id_ref = '$produto', quantidade = '$quantidade', forma_pgto = '$forma_pgto', hora = curTime() $sql_pgto $sql_usu_pgto , caixa = '$id_caixa'");	
