...
$query = $pdo->prepare("INSERT INTO $tabela SET nome = :nome, descricao = :descricao, ativo = 'Sim', foto = '$foto', valor = :valor, nome_url = '$nome_url' ");

	

}else{

$query = $pdo->prepare("UPDATE $tabela SET nome = :nome, descricao = :descricao,  ativo = 'Sim', foto = '$foto', valor = :valor, nome_url = '$nome_url' where id = '$id'");
