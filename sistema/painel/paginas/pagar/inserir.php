...
if($id == ""){
	...
	$query = $pdo->prepare("INSERT INTO $tabela SET descricao = :descricao, fornecedor = '$fornecedor', valor = :valor, data_venc = '$data_venc', data_lanc = curDate(), usuario_lanc = '$id_usuario', arquivo = '$foto', pago = 'Não', funcionario = '$funcionario', obs = :obs, hospede = '$hospede', referencia = 'Conta', forma_pgto = '$forma_pgto', hora = curTime(), caixa = '$id_caixa'");	



}else{

	$query = $pdo->prepare("UPDATE $tabela SET descricao = :descricao, fornecedor = '$fornecedor', valor = :valor, data_venc = '$data_venc', usuario_lanc = '$id_usuario', arquivo = '$foto', funcionario = '$funcionario', obs = :obs, hospede = '$hospede', forma_pgto = '$forma_pgto' where id = '$id'");
