...
<div class="row">
	...
	<div class="col-md-10">
		...
		<div class="esc" style="float:left; margin-right:10px"><span><small><i title="Data Inicial" class="fa fa-calendar-o"></i></small></span>
		...
		<div class="esc" style="float:left; margin-right:20px">
			...
			<select class="form-control sel50" aria-label="Default select example" name="status-busca" id="status-busca" style="width:200px" onchange="buscar()">
	...
	<div class="modal-dialog" role="document">
		...
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<button id="btn-fechar_fechamento" type="button" class="close" data-dismiss="modal" aria-label="Close" style="margin-top: -20px">
	...
	<div class="modal-dialog" role="document">
		...
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<button id="btn-fechar_sangria" type="button" class="close" data-dismiss="modal" aria-label="Close" style="margin-top: -20px">
