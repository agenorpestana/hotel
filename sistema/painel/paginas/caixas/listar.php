...
echo <<<HTML
			...
			<tr> 
				...
				<td>
					...
					<big><a class="{$ocultar}" href="#" onclick="editar('{$id}', '{$operador}', '{$data_abertura}','{$valor_abertura}','{$obs}')" title="Editar Dados"><i class="fa fa-edit text-primary "></i></a></big>
		...
		<big><a class="{$ocultar}" href="#" onclick="fechamento('{$id}', '{$nome_operador}', '{$valor_abertura}', '{$total_caixa}')" title="Fechar Caixa"><i class="fa fa-check-square verde "></i></a></big>


		<big><a class="{$ocultar}" href="#" onclick="sangria('{$id}', '{$nome_operador}')" title="Sangria"><i class="fa fa-money verde "></i></a></big>



		<a class="" target="_blank" href="rel/detalhamento_caixa_class.php?id={$id}" title="Detalhamento Caixa"><i class="fa fa-file-pdf-o text-danger "></i></a>
