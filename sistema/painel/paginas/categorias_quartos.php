	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 class="modal-title" id="exampleModalLabel"><span id="titulo_esp"></span></h4>
			...
			<div class="modal-body">
				...
				<div class="row">
								<div class="col-md-10">
									<input type="text" name="especificacao" id="especificacao" class="form-control" placeholder="Ex: Cama king Size, Tv 32 Polegadas">
								</div>	
								<div class="col-md-2">
				...
				<small><div align="center" id="mensagem-esp"></div></small>
...
$("#form-esp").submit(function () {
	var id = $('#id_esp').val();
    event.preventDefault();
    var formData = new FormData(this);

    $.ajax({
        url: 'paginas/' + pag + "/salvar-esp.php",
        type: 'POST',
        data: formData,
