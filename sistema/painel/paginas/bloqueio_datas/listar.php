...
for($i=0; $i<$linhas; $i++){
	...
	$query2 = $pdo->query("SELECT * from categorias_quartos where id = '$categoria'");
...
<td>
	...
	<big><a href="#" onclick="editar('{$id}','{$data_inicial}','{$data_final}','{$categoria}')" title="Editar Dados"><i class="fa fa-edit text-primary"></i></a></big>
...
<script type="text/javascript">
	...
	function editar(id, data_inicial, data_final, categoria){
