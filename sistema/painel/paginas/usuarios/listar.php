...
<big><a href="#" onclick="ativar('{$id}', '{$acao}')" title="{$titulo_link}"><i class="fa {$icone} text-success"></i></a></big>
	...
	<li class="dropdown head-dpdn2" style="display: inline-block;">
		<a title="Redefinir senha para 123" href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><big><i class="fa fa-ban text-danger"></i></big></a>
		<ul class="dropdown-menu" style="margin-left:-230px;">
		<li>
		<div class="notification_desc2">
		<p>Redefinir Senha para 123? <a href="#" onclick="redefinir('{$id}')"><span class="text-danger">Sim</span></a></p>
		</div>
		</li>
		</ul>
	</li>
...
<big><a class="{$ocultar_permissoes}" href="#" onclick="permissoes('{$id}', '{$nome}')" title="Definir Permissões"><i class="fa fa-lock " style="color:blue; margin-left:3px"></i></a></big>
