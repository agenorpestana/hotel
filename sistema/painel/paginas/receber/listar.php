...
echo <<<HTML
			...
			<tr> 
				...
				<td>
					...
					<big><a class="{$ocultar}" href="#" onclick="editar('{$id}', '{$descricao}','{$valor}','{$data_venc}','{$arquivo}', '{$obs}','{$hospede}','{$forma_pgto}')" title="Editar Dados"><i class="fa fa-edit text-primary "></i></a></big>
...
<script type="text/javascript">
	...
	function editar(id, descricao, valor, data_venc, arquivo, obs, hospede, forma_pgto){
