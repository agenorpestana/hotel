...
<td>
	...
	<big><a href="#" onclick="editar('{$id}','{$data_inicial}','{$data_final}','{$valor}','{$descricao}')" title="Editar Dados"><i class="fa fa-edit text-primary"></i></a></big>
...
<script type="text/javascript">
	...
	function editar(id, data_inicial, data_final, valor, descricao){
