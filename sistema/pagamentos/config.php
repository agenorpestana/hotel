...
$DESCRICAO_PAGAMENTO = "Compra de Reserva"; // OBRIGATÓRIO: DESCRIÇÃO PAGAMENTO O PAGAMENTO
...
//$URL_NOTIFICACAO = $url_sistema."pagamentos/webhook.php";  // URL HOSPEDADA
$URL_NOTIFICACAO = "https://seusite.com/webhook.php";  // URL LOCAL
